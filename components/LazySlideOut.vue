<template>
  <div class="wfb-slideout xs-border xs-text-6 md-text-5" :class="{ isOpen: false }">
    <div class="wfb-slideout-opener">
      <div class="hamburger hamburger--spin js-hamburger" :class="{ 'is-active': false }" @click="toggle">
    ...
    <ul class="wfb-slideout-menu list-unstyled">
      <!-- <li class="wfb-slideout-menu-item menu-logo">
        <nuxt-link
      ...
      <!-- <li v-if="categories.length" class="wfb-slideout-menu-item--small">
        <nuxt-link to="/categories" exact>Categories</nuxt-link>
      </li> -->
      <li v-for="(p, i) in pages" :key="`pg-${i}`" class="wfb-slideout-menu-item--small">
        <nuxt-link :to="p.path">
          {{ p.title }}
        </nuxt-link>
      </li>
...
.wfb-slideout-menu-item,
.wfb-slideout-menu-item--small {
  text-transform: uppercase;
}
